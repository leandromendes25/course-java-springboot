package com.leandroprojeto.config;
...
import com.leandroprojeto.repositories.OrderItemRepository;
...
//Tem o nome o nome testeConfig orque é especifico para o perfil test
@Configuration
@Profile("test")
...
//repository é o que acessa os dados
	@Override
